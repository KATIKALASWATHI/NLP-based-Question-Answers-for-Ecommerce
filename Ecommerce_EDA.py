...
###########################LDA model bulding for Quastion and Answers######################
-------------------------------------------------------------------------------------------
...
dictionary=gensim.corpora.Dictionary(words)##mapping words and their integer id's
count=0
...
doc_term_matrix=[dictionary.doc2bow(doc) for doc in words]##it shows howmany time word appear in each document
